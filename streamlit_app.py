...
def display_step():
    if st.session_state.step == 0:
        st.markdown("<div class='container'><h2>Welcome to the Customer Segmentation App</h2><p>Click the button below to begin the process.</p></div>", unsafe_allow_html=True)
        if st.button("Let's Get Started", key='start'):
